...
function PopupContact_admin()
{
	...
	$help = "'http://www.gopipulse.com/work/2012/05/18/popup-contact-form-wordpress-plugin/'";
	...
	echo '</ol>';
	echo 'Note: Check official website for more info <a href="http://www.gopipulse.com/work/2012/05/18/popup-contact-form-wordpress-plugin/" target="_blank">click here</a>';
